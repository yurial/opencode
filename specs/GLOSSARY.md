...
| core-discard-context/marked-part | A content part of an assistant or user message whose id is a member of marked-ids; eligible part types are text, reasoning, and tool for assistant messages and text and file for user messages; in the V1 runtime an assistant tool part also matches when its provider call id is a member | core-discard-context |
