...
| specs/discard-context.md | core-discard-context | stable | discard_context flag and tool across the V2 and V1 runtimes: assistant and user marked-part history filtering before lowering and compaction, flag-gated projection-only part-id markers, non-empty settled-output line, session-ui/TUI/transcript markers, exact token attribution |
