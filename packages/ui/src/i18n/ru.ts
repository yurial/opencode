export const dict = {
  ...
  "ui.messagePart.context.discarded": "Частей контекста исключено: {{count}}",
  "ui.messagePart.context.discardedTokens": "{{count}} токенов",
  ...
  "ui.tool.task": "Задача",
  "ui.tool.skill": "Навык",
  "ui.tool.discardContext": "Исключить контекст",
