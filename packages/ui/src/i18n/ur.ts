export const dict: Record<string, string> = {
  ...
  "ui.messagePart.context.discarded": "سیاق و سباق کے خارج شدہ حصے: {{count}}",
  "ui.messagePart.context.discardedTokens": "{{count}} ٹوکنز",
  ...
  "ui.tool.skill": "مہارت",
  "ui.tool.discardContext": "سیاق و سباق خارج کریں",
