export const dict = {
  ...
  "ui.messagePart.context.discarded": "Odrzucone części kontekstu: {{count}}",
  "ui.messagePart.context.discardedTokens": "{{count}} tokenów",
  ...
  "ui.tool.discardContext": "Odrzuć kontekst",
