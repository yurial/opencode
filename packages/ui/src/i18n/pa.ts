export const dict: Record<string, string> = {
  ...
  "ui.messagePart.context.discarded": "تناظر دے خارج کیتے گئے حصے: {{count}}",
  "ui.messagePart.context.discardedTokens": "{{count}} ਟੋਕਨ",
  ...
  "ui.tool.skill": "Skill",
  "ui.tool.discardContext": "تناظر خارج کرو",
