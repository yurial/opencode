...
- [ ] 1. Интерфейсы без реализации: типы job'а, статусы, конфиг `interactive.*`,
      схемы ввода/вывода 4 инструментов, точки в registry/runner
      (packages/core/src/tool, packages/schema).
- [ ] 2. Описания контрактов (doc comments) для всех новых интерфейсов.
